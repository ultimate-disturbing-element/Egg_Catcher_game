...
c.create_oval(-80,-80,102,120,fill='orange',width=0)

c.pack()
color_cycle=cycle(['light blue','light pink','light yellow','purple','light green','brown','red','blue'])
egg_width=45
egg_height=55
egg_score=10
egg_speed=500
...
lives_remaning=3
lives_text=c.create_text(canvas_width-10,10,anchor='ne',font=('Arial',16,'bold'),fill='darkblue',text='Lives :'+str(lives_remaning))
